...
private:
	ControllerDriver* controllerDriverLeft; //this provider only provides this one controller driver.
	ControllerDriver* controllerDriverRight; //this provider only provides this one controller driver.
};